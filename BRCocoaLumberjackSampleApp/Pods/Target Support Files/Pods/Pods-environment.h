...
// BRCocoaLumberjack
#define COCOAPODS_POD_AVAILABLE_BRCocoaLumberjack
#define COCOAPODS_VERSION_MAJOR_BRCocoaLumberjack 1
#define COCOAPODS_VERSION_MINOR_BRCocoaLumberjack 8
#define COCOAPODS_VERSION_PATCH_BRCocoaLumberjack 1
